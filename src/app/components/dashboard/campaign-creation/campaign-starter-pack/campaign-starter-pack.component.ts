...
@Component({
  selector: 'app-campaign-starter-pack',
  templateUrl: './campaign-starter-pack.component.html',
  styleUrls: ['./campaign-starter-pack.component.scss']
})
export class CampaignStarterPackComponent {
